...
## Step 3: Update Image
```sh
curl --location --request PATCH 'http://localhost:3000/api/users/update-my-avatar' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImlhdCI6MTc1NTIzMDMyOCwiZXhwIjoxNzU1MjMzOTI4fQ.5w4l5wf_4Fr3gJaaNxdni-PeqapxZt4YpClcpAsnvGc' \
--form 'avatar=@"/C:/Users/nguye/Downloads/Copilot_20250808_151716.png"'
```

## Step 4: Get Image
```sh
curl --location 'http://localhost:3000/uploads/image-1755233140462-975532140.jpeg'
```